...
df=getComps(c("10106 NW 13TH AVE", "32606"), "X1-ZWz1ducn32itqj_4zss3", count = 20)
# +/- 5 year band
nf = subset(df,( (df$yearBuilt >= (df[1,"yearBuilt"] - 2)) & (df$yearBuilt <= (df[1,"yearBuilt"] + 2)) ))
nf$cpsy = nf$amount/nf$finishedSqFt
nf$lcpsy = nf$lastSoldPrice/nf$finishedSqFt
nf$iolp = (nf$cpsy/nf$lcpsy - 1)
print("mean increase comparables")
mean(nf$iolp)
re