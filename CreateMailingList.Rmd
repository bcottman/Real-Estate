...
## Eliminate Latinos with listings
...
fln = paste0("Latino-OwnInv.MAILING.12012015",".xls")

writeWorksheetToFile(file = fln, data = LatinoOwnersNotInListing, sheet = "Owners")
...
#dev.off()
#
cat("Latino Owners Sales Date Catergories \n")
tabb = table(LatinoOwnersNotInListing$SaleDateCategoryLabels)
print(prop.table(tabb))
cat("Percentage of Latino Records with Sales Date > 2002,",round(sum(LatinoOwnersNotInListing$SaleDate > as.Date("2003-01-01"))
...
p +  geom_histogram(binwidth = bw,aes(fill = ..count..)) +  
  labs(title = "Yearly Latino Owner Listings Past Sales Alachua County",x="Year of Sale",y=yl) +
  scale_fill_gradient(yl, low = "red", high = "green") +
  stat_bin(binwidth=bw, geom="text",size=3, aes(label=..count..), vjust=-.5) +  
  scale_size_continuous(range = c(3, 8)) +
  theme_slanted_axis()
#dev.off()
cat("Past Sales of  Latino Owner Listings by Quarter\n")
yl = "Number of Past Sales"
bw = 365/4
...
p = ggplot(Adresses,aes(x=as.Date(SaleDate))) 
p +  geom_histogram(binwidth = bw,aes(fill = ..count..)) +  
  labs(title = "Quarterly  Latino Owner Listings Past Sales Alachua County",x="Year of Sale",y=yl) +
  scale_fill_gradient(yl, low = "red", high = "green") +
  stat_bin(binwidth=bw, geom="text",size=3, aes(label=..count..), vjust=-.5) +  
  scale_size_continuous(range = c(3, 8)) +
  theme_slanted_axis()
